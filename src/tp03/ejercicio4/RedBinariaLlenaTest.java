...
class RedBinariaLlenaTest {
	private ArbolBinario<Integer> raiz;
	private RedBinariaLlena red;
	...
	void setUp() throws Exception {
		...
		raiz.agregarHijoIzquierdo(n1);
		raiz.agregarHijoDerecho(n2);

		red = new RedBinariaLlena(raiz);
	}

	@Test
	void testRetardoReenvio() {
		assertEquals(34, red.retardoReenvio());
	}
